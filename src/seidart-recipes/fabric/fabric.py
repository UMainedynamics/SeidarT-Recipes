...
multipole2 = {
    ...
    'orientation_std': [180, 180, 180, 180, 180, 180, 180, 180, 180],
    'skew_orientation': [0, 0, 0, 0, 0, 0, 0, 0, 0]
}
...
multipole3 = {
    ...
    'trend': [83, 128, 147, 200, 240, 265],
    'trend_std': [8, 10, 10, 7, 13, 5],
    'skew_trend': [0, -10, 0, 0, -20, 0],
    'plunge': [80, 87, 45, 50, 85, 75],
    'plunge_std': [5, 5, 5, 5, 7, 4],
    'skew_plunge': [0, 0, 0, 0, 0, 0],
    'orientation': [0, 0, 0, 0, 0, 0],
    'orientation_std': [180, 180, 180, 180, 180, 180],
    'skew_orientation': [0, 0, 0, 0, 0, 0]
}

multipole3 = {
    'distribution': 'normal',
    'npts': [250, 170, 120, 60, 190, 140, 50],
    ...
    'orientation': [90, 30, 90, 160, 140, 80, 0],
    'orientation_std': [30, 30, 30, 20, 20, 20, 180],
    'skew_orientation': [0, -15, 0, 0, 0, 0, 0]
}
...
mp3.alpha = 0.3 
mp3.marker_size = 1 
mp3.projection_plot(vmin = 0.8)
mp3.projection_plot(vmin = 1.0, a_axes = True)
