...
# ------------------------------------------------------------------------------
fn_iso_x = glob('vx.isotropic.*.csv')
fn_weak_x = glob('vx.weak_vertical*.*.csv')
fn_strong_x = glob('vx.strong_vertical*.*.csv')

fn_iso_z = glob('vz.isotropic.*.csv')
fn_weak_z = glob('vz.weak_vertical*.*.csv')
fn_strong_z = glob('vz.strong_vertical*.*.csv')
...
iso_meta = pickle.load( open(glob('vx.isotropic.*.pkl')[0], 'rb') )
weak_meta = pickle.load( open(glob('vx.weak_vertical*.*.pkl')[0], 'rb') )
strong_meta = pickle.load( open(glob('vx.strong_vertical*.*.pkl')[0], 'rb') )

fs = 1/iso_meta.seismic.dt
window_length = iso_meta.seismic.time_steps-1 #2**14
...
plot_timewindow_lines(f_arrz, mag_isz, phase_isz, receiver_index = rcx)
