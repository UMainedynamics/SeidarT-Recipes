...
array_vx1 = Array('Vx', project_file, receiver_file)
array_vx1.exaggeration = 0.01 
array_vx1.save(output_basefile = 'shot1')

seis.theta = seis.theta + 90
seis.build(mat, dom, recompute_tensors = False) 
seis.kband_check(dom)
seis.run()

array_vx2 = Array('Vx', project_file, receiver_file)
array_vx2.exaggeration = 0.01 
array_vx2.save(output_basefile = 'shot2')


array_vx1.timeseries = array_vx1.timeseries + array_vx2.timeseries
array_vx1.save(output_basefile = 'stack')
